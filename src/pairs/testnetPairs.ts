...
// Monad testnet token addresses & pairs used historically by this repo.
// NOTE: These are NOT valid on mainnet. Mainnet pairs must be configured separately.
export const TESTNET_USDC_ADDRESS = "0xf817257fed379853cDe0fa4F97AB987181B1E5Ea";

export const TESTNET_HARDCODED_PAIRS: TokenPair[] = [
  {
